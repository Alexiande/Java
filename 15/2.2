...
public class MyArrayListApp <T>{
    private T[] l;
    private int count;
    private int size;

    public MyArrayListApp(){
        this(8);
    }

    public MyArrayListApp(int size) {
        this.size = size;
        l = (T[]) new Object[size];
        count = 0;
    }

    public MyArrayListApp(MyArrayListApp<T> other){
    ...
    public boolean addAll(int index, MyArrayListApp<T> other){
    ...
    public MyArrayListApp<T> subList(int start, int end){
        MyArrayListApp<T> nl = new MyArrayListApp<>();
